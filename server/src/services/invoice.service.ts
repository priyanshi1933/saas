...
export const updateInvoiceStatus = async (invoiceId: string, status: "draft" | "pending" | "paid" | "overdue") => {
  return await InvoiceModel.findByIdAndUpdate(invoiceId, { status }, { new: true });
};
