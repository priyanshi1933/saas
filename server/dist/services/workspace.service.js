...
exports.getWorkspaceSummaryForOrganization = void 0;
const client_service_1 = require("./client.service");
const invoice_service_1 = require("./invoice.service");
const payment_service_1 = require("./payment.service");
const subscription_service_1 = require("./subscription.service");
const getWorkspaceSummaryForOrganization = async (organizationId) => {
    const [clients, invoices, payments, subscriptions] = await Promise.all([
        (0, client_service_1.getClientsByOrganization)(organizationId),
        (0, invoice_service_1.getInvoicesByOrganization)(organizationId),
        (0, payment_service_1.getPaymentsByOrganization)(organizationId),
        (0, subscription_service_1.getSubscriptionsByOrganization)(organizationId),
    ]);
    ...
    const mrr = activeSubscriptions.reduce((sum, subscription) => {
        const billingCycle = subscription.billingCycle || subscription.interval || "monthly";
...
exports.getWorkspaceSummaryForOrganization = getWorkspaceSummaryForOrganization;
