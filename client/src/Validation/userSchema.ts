...
export const subscriptionStatusValues = ["trial", "active", "paused", "canceled"] as const;
...
export const subscriptionSchema = Joi.object({
  ...
  interval: Joi.string()
    ...
    .required()
    .messages({
      "any.only": "Please select a valid billing interval",
  ...
  status: Joi.string()
    ...
    .required()
    .messages({
      "any.only": "Please select a valid subscription status",
